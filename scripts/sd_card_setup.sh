...
# TF-1.15
sudo pip3 install --pre --extra-index-url https://developer.download.nvidia.com/compute/redist/jp/v45 "tensorflow<2" # NVIDIA's installation instructions use single quotations and it doesn't work
...
sudo apt install -y nodejs libffi-dev nodejs-dev node-gyp libssl1.0-dev
